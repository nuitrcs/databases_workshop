...
library(RPostgreSQL)
con <- dbConnect(dbDriver("PostgreSQL"), host="localhost", dbname="workshop") 
...
Note: the process of creating database tables and populating them from R is a bit messy and doesn't have a good natural workflow.  This exercise is to help you get used to doing it, but you generally want to avoid creating databases from R in most circumstances.  Use R to select data from databases, not create databases.
